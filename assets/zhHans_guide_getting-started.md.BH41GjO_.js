import{_ as a,o as i,c as n,a2 as e}from"./chunks/framework.BXzK3EA4.js";const o=JSON.parse('{"title":"入门","description":"安装 VitePress Sidebar，了解它如何扫描文档，以及如何在 withSidebar 和 generateSidebar 之间做出选择。","frontmatter":{"order":1,"description":"安装 VitePress Sidebar，了解它如何扫描文档，以及如何在 withSidebar 和 generateSidebar 之间做出选择。"},"headers":[],"relativePath":"zhHans/guide/getting-started.md","filePath":"zhHans/guide/getting-started.md","lastUpdated":1790211691000}'),p={name:"zhHans/guide/getting-started.md"};function l(t,s,h,k,r,d){return i(),n("div",null,[...s[0]||(s[0]=[e(`<h1 id="入门" tabindex="-1">入门 <a class="header-anchor" href="#入门" aria-label="Permalink to &quot;入门&quot;">​</a></h1><p>本页面将指导您安装和使用&quot;VitePress Sidebar&quot;模块。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><p>首先，在使用本模块之前，您可能需要预先配置 <strong><a href="https://vitepress.dev/zh/" target="_blank" rel="noreferrer">VitePress</a></strong>。</p><p>我们建议使用 <strong>Node.js 22.x</strong> 或更高版本。<strong>VitePress Sidebar</strong>是用<code>ESM</code>编写的。要在 &quot;CommonJS&quot; 中使用它，<a href="/zhHans/troubleshooting/err-require-esm">请参见此处的说明</a>。</p><p>您需要使用 <a href="https://www.npmjs.com/package/vitepress-sidebar" target="_blank" rel="noreferrer">NPM</a> 或任何其他 Node 模块包管理器安装该模块。该软件包应安装在 <code>devDependencies</code> 中，因为它仅在开发人员环境中使用。使用下面的命令：</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># via npm</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    ]</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre></div><p>这样就无需在 “边栏 ”中手动创建每个菜单。</p><h2 id="如何使用" tabindex="-1">如何使用 <a class="header-anchor" href="#如何使用" aria-label="Permalink to &quot;如何使用&quot;">​</a></h2><p>VitePress Sidebar 可通过两个函数自动生成侧边栏：<code>withSidebar</code> 和 <code>generateSidebar</code>。通常，我们建议使用 <code>withSidebar</code>，它支持热重载，也是标准做法。</p><p>要将安装的模块导入代码，请打开VitePress的<code>config.js</code>文件。请注意，该文件位于<code>.vitepress</code>目录下，扩展名可能有所不同，具体取决于您的项目。</p><p>文件，并以以下两种方式之一使用 <code>vitepress-sidebar</code>.</p><h3 id="_1-使用-withsidebar-推荐" tabindex="-1">1. 使用 <code>withSidebar</code>（推荐） <a class="header-anchor" href="#_1-使用-withsidebar-推荐" aria-label="Permalink to &quot;1. 使用 \`withSidebar\`（推荐）&quot;">​</a></h3><p><code>withSidebar</code> 用于 <code>defineConfig</code> 级别。请注意，VitePress 的配置对象应放在第一个参数中，VitePress 侧边栏的选项应放在第二个参数中。</p><p>VitePress 侧边栏将覆盖 VitePress 中现有选项所需的任何附加选项。 您已手动设置的任何 <code>sidebar</code> 选项都将被新选项覆盖。</p><p>它还会读取 VitePress 配置中的 <a href="/zhHans/guide/options#vitepress-srcexclude"><code>srcExclude</code></a>，因此被排除在构建之外的页面不会出现在侧边栏中，无需再排除一次。</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// \`.vitepress/config.js\`</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> default</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> defineConfig</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">withSidebar</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(vitePressOptions, vitePressSidebarOptions));</span></span></code></pre></div><p>要测试侧边栏结果如何打印，请在构建 VitePress 时将 <code>debugPrint</code> 选项设置为 <code>true</code>。你应该能在控制台中看到输出结果。</p><p>有关 VitePress Sidebar 配置的更多信息,请参阅下面的 <strong><a href="/zhHans/guide/options">选项</a></strong> 部分。</p><h2 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h2><p>选项不一定要作为参数传入。将 <code>sidebar.config.json</code> 文件放在文档旁边即可被自动识别，它会应用于该文件所在的文件夹<strong>以及其下的所有子文件夹</strong>，因此文档的各个部分都可以定义各自的规则。</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// docs/sidebar.config.json</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>有了上面的文件，VitePress 配置只需要这些：</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// docs/.vitepress/config.mjs</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { withSidebar } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;vitepress-sidebar&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> default</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> defineConfig</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">withSidebar</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({ title: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;My Docs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> }));</span></span></code></pre></div><p>详情请参阅 <strong><a href="/zhHans/advanced-usage/configuration-file">配置文件</a></strong> 页面。</p><h2 id="代码示例" tabindex="-1">代码示例 <a class="header-anchor" href="#代码示例" aria-label="Permalink to &quot;代码示例&quot;">​</a></h2><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { withSidebar } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;vitepress-sidebar&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
