import{_ as a,c as n,a2 as i,o as p}from"./chunks/framework.DPuwY6B9.js";const u=JSON.parse('{"title":"国际化","description":"","frontmatter":{},"headers":[],"relativePath":"zhHans/advanced-usage/internationalization.md","filePath":"zhHans/advanced-usage/internationalization.md","lastUpdated":1730678716000}'),t={name:"zhHans/advanced-usage/internationalization.md"};function e(l,s,o,h,k,c){return p(),n("div",null,s[0]||(s[0]=[i(`<h1 id="国际化" tabindex="-1">国际化 <a class="header-anchor" href="#国际化" aria-label="Permalink to &quot;国际化&quot;">​</a></h1><p>本页介绍如何使用 VitePress Sidebar 实现国际化（i18n）。</p><p>VitePress 支持多语言文档。如果您将翻译好的标记文件放在每种语言的目录中，并在 VitePress 的 <code>defineConfig</code> 中使用 <code>locales</code> 选项，就会显示语言选择器，并显示指定目录中每种语言的文档。</p><h2 id="翻译页面布局-手动" tabindex="-1">翻译页面布局（手动） <a class="header-anchor" href="#翻译页面布局-手动" aria-label="Permalink to &quot;翻译页面布局（手动）&quot;">​</a></h2><p>首先，VitePress 允许您翻译各种布局界面元素。所谓布局，是指 “上一页”、“下一页”、“目录”、“更改主题 ”等功能的所有相关文本。 它还包括翻译搜索功能中出现的所有文本。</p><p>VitePress 页面上的各种界面（布局）文本可提供特定语言的 <code>locales</code> 翻译。例如:</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&quot;locales&quot;: {</span></span>
