import{_ as a,o as i,c as n,a2 as e}from"./chunks/framework.BXzK3EA4.js";const o=JSON.parse('{"title":"시작하기","description":"VitePress Sidebar를 설치하고, 문서를 읽어 사이드바를 만드는 방식과 withSidebar, generateSidebar 중 무엇을 쓸지 알아봅니다.","frontmatter":{"order":1,"description":"VitePress Sidebar를 설치하고, 문서를 읽어 사이드바를 만드는 방식과 withSidebar, generateSidebar 중 무엇을 쓸지 알아봅니다."},"headers":[],"relativePath":"ko/guide/getting-started.md","filePath":"ko/guide/getting-started.md","lastUpdated":1790211691000}'),p={name:"ko/guide/getting-started.md"};function l(t,s,h,k,r,d){return i(),n("div",null,[...s[0]||(s[0]=[e(`<h1 id="시작하기" tabindex="-1">시작하기 <a class="header-anchor" href="#시작하기" aria-label="Permalink to &quot;시작하기&quot;">​</a></h1><p>이 페이지에서는 VitePress Sidebar 모듈의 설치 및 사용 방법을 안내합니다.</p><h2 id="설치" tabindex="-1">설치 <a class="header-anchor" href="#설치" aria-label="Permalink to &quot;설치&quot;">​</a></h2><p>먼저 이 모듈을 사용하기 전에 <strong><a href="https://vitepress.dev/ko/" target="_blank" rel="noreferrer">VitePress</a></strong> 모듈을 사전 구성해야 할 수 있습니다.</p><p>Node.js 버전은 22.x 이상을 사용하는 것이 좋습니다. <strong>VitePress Sidebar</strong>는 <code>ESM</code>으로 작성되었습니다. CommonJS 환경에서 사용하려면 <a href="/ko/troubleshooting/err-require-esm">여기 지침을 참조하세요</a>.</p><p><a href="https://www.npmjs.com/package/vitepress-sidebar" target="_blank" rel="noreferrer">NPM</a> 또는 다른 노드 모듈 패키지 관리자를 사용하여 모듈을 설치할 수 있습니다. 이 패키지는 개발자 환경에서만 사용되므로 <code>devDependencies</code>에 설치해야 합니다. 아래 명령어로 설치하세요:</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># \`npm\`으로 설치</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    ]</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre></div><p>이로 인해 <code>sidebar</code>의 각 메뉴에 대한 수동 작성이 필요하지 않습니다.</p><h2 id="사용-방법" tabindex="-1">사용 방법 <a class="header-anchor" href="#사용-방법" aria-label="Permalink to &quot;사용 방법&quot;">​</a></h2><p>VitePress Sidebar는 <code>withSidebar</code>와 <code>generateSidebar</code> 두가지 함수로 사이드 바를 자동으로 생성할 수 있습니다. 이 둘의 동작은 같지만 함수를 사용하는 위치가 다릅니다. 일반적으로는 핫 리로드를 지원하고 정석적인 방법인 <code>withSidebar</code>를 사용하는 것을 권장합니다.</p><p>설치한 모듈을 코드에 가져오려면 VitePress의 <code>config.js</code> 파일을 엽니다. 이 파일은 <code>.vitepress</code> 디렉토리에 위치하며 프로젝트에 따라 다른 확장자의 이름일 수 있으니 유의하시기 바랍니다.</p><p>파일을 열고 아래 두가지 방법 중 하나를 사용하여 <code>vitepress-sidebar</code>를 사용할 수 있습니다:</p><h3 id="_1-withsidebar-사용-권장" tabindex="-1">1. <code>withSidebar</code> 사용 (권장) <a class="header-anchor" href="#_1-withsidebar-사용-권장" aria-label="Permalink to &quot;1. \`withSidebar\` 사용 (권장)&quot;">​</a></h3><p><code>withSidebar</code>는 <code>defineConfig</code>레벨에서 사용합니다. 이 때 주의할 점은 VitePress의 설정 객체가 첫번째 파라미터에, 이후 VitePress Sidebar의 옵션이 두번째 파라미터에 위치해야 합니다.</p><p>VitePress Sidebar는 기존 VitePress의 옵션에 필요한 추가 옵션을 오버라이딩 할 것입니다. 기존에 설정한 수동 <code>sidebar</code> 옵션은 새 옵션에 의해 무시됩니다.</p><p>또한 VitePress 설정의 <a href="/ko/guide/options#vitepress-srcexclude"><code>srcExclude</code></a>를 함께 읽으므로, 빌드에서 제외한 문서는 사이드바에도 표시되지 않으며 같은 경로를 두 번 제외할 필요가 없습니다.</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// \`.vitepress/config.js\`</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> default</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> defineConfig</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">withSidebar</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(vitePressOptions, vitePressSidebarOptions));</span></span></code></pre></div><p>사이드바 결과가 어떻게 출력되는지 테스트하려면 <code>debugPrint</code> 옵션을 <code>true</code>로 설정하여 VitePress를 빌드해 보세요. 콘솔에 출력이 표시될 것입니다.</p><p>VitePress Sidebar의 설정에 대한 자세한 내용은 아래 <strong><a href="/ko/guide/options">옵션</a></strong> 섹션을 참조하세요.</p><h2 id="설정-파일" tabindex="-1">설정 파일 <a class="header-anchor" href="#설정-파일" aria-label="Permalink to &quot;설정 파일&quot;">​</a></h2><p>옵션을 반드시 인자로 전달해야 하는 것은 아닙니다. 문서 옆에 <code>sidebar.config.json</code> 파일을 두면 자동으로 인식되며, 파일이 위치한 폴더와 <strong>그 하위의 모든 폴더</strong>에 적용됩니다. 따라서 문서의 영역별로 서로 다른 규칙을 정의할 수 있습니다.</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// docs/sidebar.config.json</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>위와 같이 파일을 두면 VitePress 설정은 다음으로 충분합니다:</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// docs/.vitepress/config.mjs</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { withSidebar } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;vitepress-sidebar&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> default</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> defineConfig</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">withSidebar</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({ title: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;My Docs&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> }));</span></span></code></pre></div><p>자세한 내용은 <strong><a href="/ko/advanced-usage/configuration-file">설정 파일</a></strong> 페이지를 참고하세요.</p><h2 id="코드-예시" tabindex="-1">코드 예시 <a class="header-anchor" href="#코드-예시" aria-label="Permalink to &quot;코드 예시&quot;">​</a></h2><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { withSidebar } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;vitepress-sidebar&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>];</span></span>
<span class="line"><span>*/</span></span></code></pre></div>`,43)])])}const g=a(p,[["render",l]]);export{o as __pageData,g as default};
