import{_ as a,c as i,o as n,ag as p}from"./chunks/framework.Bw-5EFTY.js";const o=JSON.parse('{"title":"시작하기","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"ko/guide/getting-started.md","filePath":"ko/guide/getting-started.md","lastUpdated":1753319507000}'),e={name:"ko/guide/getting-started.md"};function l(t,s,h,k,r,d){return n(),i("div",null,s[0]||(s[0]=[p(`<h1 id="시작하기" tabindex="-1">시작하기 <a class="header-anchor" href="#시작하기" aria-label="Permalink to &quot;시작하기&quot;">​</a></h1><p>이 페이지에서는 VitePress Sidebar 모듈의 설치 및 사용 방법을 안내합니다.</p><h2 id="설치" tabindex="-1">설치 <a class="header-anchor" href="#설치" aria-label="Permalink to &quot;설치&quot;">​</a></h2><p>먼저 이 모듈을 사용하기 전에 <strong><a href="https://vitepress.dev/ko/" target="_blank" rel="noreferrer">VitePress</a></strong> 모듈을 사전 구성해야 할 수 있습니다.</p><p>Node.js 버전은 18.x 이상을 사용하는 것이 좋습니다. <strong>VitePress Sidebar</strong>는 <code>ESM</code>으로 작성되었습니다. CommonJS 환경에서 사용하려면 <a href="/ko/troubleshooting/err-require-esm">여기 지침을 참조하세요</a>.</p><p><a href="https://www.npmjs.com/package/vitepress-sidebar" target="_blank" rel="noreferrer">NPM</a> 또는 다른 노드 모듈 패키지 관리자를 사용하여 모듈을 설치할 수 있습니다. 이 패키지는 개발자 환경에서만 사용되므로 <code>devDependencies</code>에 설치해야 합니다. 아래 명령어로 설치하세요:</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># \`npm\`으로 설치</span></span>
