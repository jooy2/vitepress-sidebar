...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>(<code>root</code> 언어는 페이지에서 주 언어를 의미합니다.)</p><p>레이아웃 번역을 자세히 알아보려면 다음 문서를 참고하세요: <a href="https://vitepress.dev/guide/i18n" target="_blank" rel="noreferrer">https://vitepress.dev/guide/i18n</a></p><p>검색 기능에 표시되는 텍스트의 경우 <code>defineConfig</code>의 <code>themeConfig.search</code> 옵션에서 설정해야 합니다. 예를 들면 다음과 같습니다:</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&quot;themeConfig&quot;: {</span></span>
