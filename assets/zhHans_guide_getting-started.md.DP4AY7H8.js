import{_ as a,c as i,o as n,ag as p}from"./chunks/framework.Bw-5EFTY.js";const o=JSON.parse('{"title":"入门","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"zhHans/guide/getting-started.md","filePath":"zhHans/guide/getting-started.md","lastUpdated":1753319507000}'),e={name:"zhHans/guide/getting-started.md"};function l(t,s,h,k,r,d){return n(),i("div",null,s[0]||(s[0]=[p(`<h1 id="入门" tabindex="-1">入门 <a class="header-anchor" href="#入门" aria-label="Permalink to &quot;入门&quot;">​</a></h1><p>本页面将指导您安装和使用&quot;VitePress Sidebar&quot;模块。</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><p>首先，在使用本模块之前，您可能需要预先配置 <strong><a href="https://vitepress.dev/zh/" target="_blank" rel="noreferrer">VitePress</a></strong>。</p><p>我们建议使用 <strong>Node.js 18.x</strong> 或更高版本。<strong>VitePress Sidebar</strong>是用<code>ESM</code>编写的。要在 &quot;CommonJS&quot; 中使用它，<a href="/zhHans/troubleshooting/err-require-esm">请参见此处的说明</a>。</p><p>您需要使用 <a href="https://www.npmjs.com/package/vitepress-sidebar" target="_blank" rel="noreferrer">NPM</a> 或任何其他 Node 模块包管理器安装该模块。该软件包应安装在 <code>devDependencies</code> 中，因为它仅在开发人员环境中使用。使用下面的命令：</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># via npm</span></span>
